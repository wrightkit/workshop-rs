...
Accepted for the `workshop-rs` hero/gameplay data track (#22–#25).

> Registry note: this decision was originally committed with the duplicate identifier `ADR-0002`. It was renumbered to ADR-0007 during architecture-knowledge normalization; the decision content is unchanged.
