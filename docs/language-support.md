...
| [Values Inventory](language-support/values.md) | ✅ Supported | Complete inventory of all 255 canonical Workshop values and expressions with types | [`values.md`](language-support/values.md) |
...
| [Strings & Localization](language-support/strings.md) | ✅ Supported | `Custom String`, preset strings, `en-US`, `zh-CN`, bidirectional conversion (additional locales `🚧 Coming soon`) | [`strings.md`](language-support/strings.md) |
