...
| [Values Inventory](language-support/values.md) | ✅ Supported | 252 supported values & expressions; 3 external value contracts (`Raise To Power`, `Randomized Array`, `String`) `🚧 Coming soon` | [`values.md`](language-support/values.md) |
...
| [Strings & Localization](language-support/strings.md) | ✅ Supported | `Custom String`, preset strings, `en-US`, `zh-CN`, bidirectional conversion (additional locales & `String` value `🚧 Coming soon`) | [`strings.md`](language-support/strings.md) |
