...
/// The pinned digest of the committed catalog dataset (version 0.1.4).
///
...
const PINNED_CATALOG_DIGEST: &str =
    "5ce8682b51c83eca139aea07f5fe533480e3b5de4f9c83232e8b6c986236cf43";
...
fn identity_reports_all_four_machine_readable_identities() {
    ...
    assert_eq!(identity.catalog_version, "0.1.4");
    assert_eq!(
