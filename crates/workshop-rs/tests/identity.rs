...
/// The pinned digest of the committed catalog dataset (version 0.1.6).
///
...
const PINNED_CATALOG_DIGEST: &str =
    "b3e38df903eaa3ceb0199a228d74cdf60586fe10299c6be697396961122e5079";
...
fn identity_reports_all_four_machine_readable_identities() {
    ...
    assert_eq!(identity.catalog_version, "0.1.6");
    assert_eq!(
