...
pub static GENERATED_ENUM_MEMBERS: &[EnumMember] = &[
    ...
    EnumMember {
        domain: "setting_gamemodes_control_setValidControlPoints",
        member: "all",
        name: "All",
    },
    EnumMember {
    ...
    EnumMember {
        domain: "setting_gamemodes_ctf_flagCarrierAbilities",
        member: "all",
        name: "All",
    },
    EnumMember {
    ...
    EnumMember {
        domain: "setting_gamemodes_elimination_heroPoolSize",
        member: "teamSize",
        name: "Team Size",
    },
    EnumMember {
    ...
    EnumMember {
        domain: "setting_gamemodes_elimination_heroesAvailable",
        member: "any",
        name: "Any",
    },
    EnumMember {
    ...
    EnumMember {
        domain: "setting_gamemodes_elimination_heroesAvailable",
        member: "mirroredRandom",
        name: "Random Mirrored",
    },
    EnumMember {
        domain: "setting_gamemodes_elimination_restrictPreviouslyPlayedHeroes",
        member: "off",
        name: "Off",
    },
    EnumMember {
        domain: "setting_gamemodes_elimination_restrictPreviouslyPlayedHeroes",
        member: "afterRoundWon",
        name: "After Round Won",
    },
    EnumMember {
        domain: "setting_gamemodes_elimination_restrictPreviouslyPlayedHeroes",
        member: "afterRoundPlayed",
        name: "After Round Played",
    },
    EnumMember {
        domain: "setting_gamemodes_flashpointAprilFools_firstActiveControlPoint",
        member: "a",
        name: "A",
    },
    EnumMember {
    ...
    EnumMember {
        domain: "setting_gamemodes_flashpoint_firstActiveControlPoint",
        member: "a",
        name: "A",
    },
    EnumMember {
    ...
    EnumMember {
        domain: "setting_gamemodes_junkenstein_difficulty",
        member: "normal",
        name: "NORMAL",
    },
    EnumMember {
    ...
    EnumMember {
        domain: "setting_gamemodes_skirmish_setValidControlPoints",
        member: "all",
        name: "All",
    },
    EnumMember {
    ...
    EnumMember {
        domain: "setting_heroes_TEAM_HERO_weaponsEnabled",
        member: "all",
        name: "All",
    },
    EnumMember {
        domain: "setting_heroes_TEAM_HERO_weaponsEnabled",
        member: "staff",
        name: "Caduceus Staff Only",
    },
    EnumMember {
        domain: "setting_heroes_TEAM_HERO_weaponsEnabled",
        member: "blaster",
        name: "Caduceus Blaster Only",
    },
    EnumMember {
        domain: "setting_heroes_TEAM_HERO_weaponsEnabled",
        member: "all",
    ...
    EnumMember {
        domain: "setting_heroes_TEAM_HERO_weaponsEnabled",
        member: "healingBlossom",
        name: "Healing Blossom Only",
    },
    EnumMember {
        domain: "setting_heroes_TEAM_HERO_weaponsEnabled",
        member: "thornVolley",
        name: "Thorn Volley Only",
    },
    EnumMember {
        domain: "setting_lobby_dataCenterPreference",
        member: "bestAvailable",
        name: "Best Available",
    },
    EnumMember {
        domain: "setting_lobby_dataCenterPreference",
    ...
    EnumMember {
        domain: "setting_lobby_dataCenterPreference",
        member: "chinaHangzhou",
        name: "China - Hangzhou",
    },
    EnumMember {
        domain: "setting_lobby_dataCenterPreference",
        member: "chinaHangzhou2",
        name: "China - Hangzhou 2",
    },
    EnumMember {
        domain: "setting_lobby_dataCenterPreference",
        member: "finland2",
